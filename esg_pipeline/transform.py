        ...
        for idx, row in final_report_df.iterrows():
            try:
                ...
                respondent = {
                    ...
                    "team": report.get("playerProfile", {}).get("team", "") or report.get("playerProfile", {}).get("branch", "") or row.get("team", ""),
                    "department": report.get("playerProfile", {}).get("department", "") or row.get("department", ""),
